...
ggsave("d_m_f_core_microbiome.png", d_m_f_core_microbiome, height = 5, width = 7)
ggsave("pd_m_f_core_microbiome.png", pd_m_f_core_microbiome, height = 5, width = 7)
ggsave("nd_m_f_core_microbiome.png", nd_m_f_core_microbiome, height = 5, width = 7)
