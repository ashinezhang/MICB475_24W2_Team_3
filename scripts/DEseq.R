...
ggsave(filename = "data/plot_richness.png"
       , gg_richness
       , height=4, width=6)
...
ggsave(filename="data/vol_plot.png",vol_plot)
...
ggsave(filename="data/log_bar_plot.png",log_bar_plot)
