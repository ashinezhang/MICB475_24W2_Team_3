...
ggsave("d_pd_f_core_microbiome.png", d_pd_f_core_microbiome, height = 12, width = 15)
ggsave("d_pd_m_core_microbiome.png", d_pd_m_core_microbiome, height = 12, width = 15)
